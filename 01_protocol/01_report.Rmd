...
1. Download food supply data: The data can be downloaded from Faostat website (http://www.fao.org/faostat/en/). On "Data" tab, we accessed "Food Balances (2010-)" (under Food Balances). We selected:
  ...
  - "Regions" = Eastern Africa + (List), Middle Africa + (List),  Southern Africa + (List), Western Africa + (List).
...
#Checking with energy intake


When using Western Africa FCT for Middle Africa FCT, we have four food categories that are different in the top10 energy selection: "millet and products", "palm oil" , "sorghum and products", "sugar (raw equivalent)". 
