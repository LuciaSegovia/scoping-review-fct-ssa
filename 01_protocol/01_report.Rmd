...
We downloaded food supply data (Energy) by applying the same filters as above except for "Elements" which was changed to "Food supply (kcal/capita/year)".
...
We downloaded the data on: 05/05/2021.
